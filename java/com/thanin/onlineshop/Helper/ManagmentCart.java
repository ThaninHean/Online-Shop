package com.thanin.onlineshop.Helper;
...
public class ManagmentCart {
    ...
    public void minusItem(ArrayList<PopularDomain> listItem, int position, ChangeNumberItemsListener changeNumberItemsListener) {
    ...
    public void plusItem(ArrayList<PopularDomain> listItem, int position, ChangeNumberItemsListener changeNumberItemsListener) {
        listItem.get(position).setNumberInCart(listItem.get(position).getNumberInCart() + 1);
        tinyDB.putListObject("CartList", listItem);
        changeNumberItemsListener.changed();
    }
    ...
    public Double getTotalFee() {
        ArrayList<PopularDomain> listItem2 = getListCart();
        double fee = 0;
